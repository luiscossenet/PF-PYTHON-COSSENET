...
# AppMagico/views/profile_views.py
def profile_function_view(request):
    return render(request, "profile.html")
    ...
    if request.method == "POST":
        ...
        if myFormEstado.is_valid():
            ...
            try:
                ...
                swEstado = False
                myFormEstado = EstadoSelectAllForm()
            return redirect("RV_vEstadosUpdate")
        else:
            myFormEstado = EstadoSelectAllForm()
    return redirect("RV_vEstadosUpdate")
    ...
    if request.method == "POST":
        ...
        if myFormEstado.is_valid():
            ...
            try:
                ...
                swEstado = False
                myFormEstado = EstadoSelectAllForm()
            return redirect("RV_vEstadosDelete")
        else:
            myFormEstado = EstadoSelectAllForm()
    return redirect("RV_vEstadosDelete")
...
class CargosCreateView(CreateView):
    ...
    success_url = reverse_lazy("RV_vCargosSelect")
...
class CargosUpdateView(ListView):
    model = Cargos
    context_object_name = "cargos"
    ordering = ["nombre"]
    paginate_by = 10
...
class CargosUpdateRowView(UpdateView):
    model = Cargos
    # form_class = CargosForm
    template_name = "pages/cargosUpdateRow.html"
    success_url = reverse_lazy("RV_vCargosUpdate")
...
class CargosDeleteView(ListView):
    model = Cargos
    context_object_name = "cargos"
    ordering = ["nombre"]
    paginate_by = 10
...
class CargosDeleteRowView(DeleteView):
    model = Cargos
    template_name = "pages/cargosDeleteRow.html"
    success_url = reverse_lazy("RV_vCargosDelete")
    # context_object_name = "cargos"
    fields = ["nombre", "id_empresa", "id_estado"]
